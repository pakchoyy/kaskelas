...
export function mapContributionTypeToApi(type: string): 'kas_kelas' | 'amal_jumat' | 'paguyuban_ngaji' | 'tabungan' {
  const mapping: Record<string, 'kas_kelas' | 'amal_jumat' | 'paguyuban_ngaji' | 'tabungan'> = {
    'kas-kelas': 'kas_kelas',
...
export function mapContributionTypeFromApi(type: string): 'kas-kelas' | 'amal-jumat' | 'paguyuban-ngaji' | 'tabungan' {
  const mapping: Record<string, 'kas-kelas' | 'amal-jumat' | 'paguyuban-ngaji' | 'tabungan'> = {
    'kas_kelas': 'kas-kelas',
